...
public class PersistenceTest {
    ...
    public void persistenceTest(){
        ...
        assertTrue(listResult.success, "User auth not found in database after restart");
        assertEquals(2, listResult.games.length, "Missing game(s) in database after restart");
        ...
        assertEquals("test1", game1.gameName, "Game name changed after restart");
        assertEquals(createResult.gameID, game1.gameID, "Game ID Changed after restart");
        assertEquals("test2", game2.gameName, "Game name changed after restart");
        assertEquals(createResult2.gameID, game2.gameID, "Game ID changed after restart");

        //check players in test1 game
        assertEquals(existingUser.username, game1.whiteUsername, "White player username changed after restart");
        assertEquals(newUser.username, game1.blackUsername, "Black player username changed after restart");
        ...
        assertTrue(loginResult.success, "Second user not able to log in after restart");
        //-------------------------------------------------------------------------------------------------------------
    }
